      ...
      {result.unavailable ? (
        ...
        <>
          <section className="standards-readiness-intro">
            ...
            <p>
              This candidate exposes release and provenance metadata only. Bulk and CASE exports are
              explicitly denied while rights review and publication remain unresolved.
            </p>
          </section>
