...
- Exact-candidate hosted evidence is not available for the current local repository candidate. Historical Forgejo runs 61/container, 62/Lighthouse, and 63/quality failed for `06491dc…`; later remote dispatches 64–69 targeted the then-pushed `dc6d78a…` source and were rejected before runner assignment. None is current-candidate evidence.
